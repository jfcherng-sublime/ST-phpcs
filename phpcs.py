...
class Pref:
    ...
    def apply_settings_template(self, settings: sublime.Settings) -> sublime.Settings:
        ...
        for key in self.templated_keys:
            settings.set(key, sublime.expand_variables(settings.get(key), template_variables))
